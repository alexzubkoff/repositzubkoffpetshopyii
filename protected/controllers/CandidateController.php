...
class CandidateController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','candidatesforhire'),
				'users'=>array('*'),
			),
	...
	public function actionIndex()
	{
        ...
        public function actionCandidatesforhire()
	{
		$criteria = new CDbCriteria;
                $criteria->condition = "profile = (SELECT MAX(project) FROM tbl_teams) ";
                $data = new  CActiveDataProvider('Candidate', array(
			'criteria'=>$criteria,
		));
                $this->render('index',array(
			'dataProvider'=>$data,
